...
.AUTHOR Surendar.n@hcltech.com

.COMPANYNAME HCLTech

.COPYRIGHT Surendar.n@hcltech.com
...
.DESCRIPTION
   ...
   Author:
   Surendar.n@hcltech.com
   Associate consultant
   Microsoft MVP - Azure with Saas Administrator
...
.EXAMPLE
   .\Get-MDMDiagnostics.ps1
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -AllLogEvents -AllLogFiles
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -AllLogEvents -ShowAllTimelineEvents
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ShowLogViewerUI
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ShowLogViewerUI -ConvertAllKnownGuidsToClearText
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -Today
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -LogStartDateTime "10.3.2023 5.00:00" -LogEndDateTime "11.3.2023 23.00:00"
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\IntuneManagementExtension.log"
.EXAMPLE
    .\Get-MDMDiagnostics.ps1 -LogFile "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\IntuneManagementExtension.log"
.EXAMPLE
    .\Get-MDMDiagnostics.ps1 -LogFilesFolder "C:\temp\MDMDiagReport"
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ShowStdOutInReport
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ShowErrorsInReport
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ShowErrorsSummary
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ExportTextFileName ExportTextFile.txt
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -Online -ExportTextFileName C:\temp\ExportTextFile.txt
.EXAMPLE
   .\Get-MDMDiagnostics.ps1 -AllLogEntries -AllLogFiles -ExportTextFileName C:\temp\ExportTextFile.txt
.EXAMPLE
   Get-ChildItem "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\IntuneManagementExtension.log" | .\Get-MDMDiagnostics.ps1 -AllLogEntries -Online
.INPUTS
...
.NOTES
   ...
   Save-Script Get-MDMDiagnostics -Path ./
.LINK
   https://github.com/petripaavola/Get-MDMDiagnostics
#>
...
Write-Host "Get-MDMDiagnostics.ps1 $ScriptVersion" -ForegroundColor Cyan
Write-Host "Author: Surendar.n@hcltech.com / Microsoft MVP - Azure SaaS Administrator"
Write-Host ""
...
Write-Host "Starting Get-MDMDiagnostics`n"
...
#>			
	...
	if($ExportTextFileName) {
		...
		"Get-MDMDiagnostics.ps1 $ScriptVersion report" | Out-File -FilePath $ExportTextFileName -Force
		"https://github.com/petripaavola/Get-MDMDiagnostics`n" | Out-File -FilePath $ExportTextFileName -Append
...
"@
		...
		try {
			...
			$PreContent = @"
		<header>
		  <h1>Get-MDMDiagnostics ver $ScriptVersion</h1>
		  ...
		  <div class="author-info">
			<p><a href="https://github.com/petripaavola/Get-MDMDiagnostics" target="_blank"><strong>Download Report tool from GitHub</strong></a><br>Author: Surendar Nehru - Microsoft MVP</p>
		  </div>
		</header>
		<br>
"@
		...
		<footer>
			...
			<p style="margin: 0;">
			  <a href="https://github.com/petripaavola/Get-MDMDiagnostics" target="_blank"><strong>Download Get-MDMDiagnostics from GitHub</strong<</a>
			</p>
		</footer>
		<script>
...
"@
		...
		$Title = "Get-MDMDiagnostics Observed Timeline Report"
		...
		if (-not ($Success)) {
			...
			Write-Host "Get-MDMDiagnostics report HTML file created:`n`t$ReportSavePath\$HTMLFileName`n" -ForegroundColor Green
		}
